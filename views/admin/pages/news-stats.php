...
<div class="pagination">
    <?php if ($totalPages > 1): ?>
        <?php if ($page > 1): ?>
            <a href="/shoesWebsite/index.php?controller=adminNews&action=stats&search=<?php echo urlencode($search); ?>&page=<?php echo $page - 1; ?>">Previous</a>
        <?php endif; ?>

        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <a href="/shoesWebsite/index.php?controller=adminNews&action=stats&search=<?php echo urlencode($search); ?>&page=<?php echo $i; ?>" <?php echo $i === $page ? 'class="active"' : ''; ?>><?php echo $i; ?></a>
        <?php endfor; ?>

        <?php if ($page < $totalPages): ?>
            <a href="/shoesWebsite/index.php?controller=adminNews&action=stats&search=<?php echo urlencode($search); ?>&page=<?php echo $page + 1; ?>">Next</a>
        <?php endif; ?>
    <?php endif; ?>
</div>
