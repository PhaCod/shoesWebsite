...
<div class="admin-form">
    <form action="/shoesWebsite/views/admin/index.php?controller=adminProduct&action=editProduct&id=<?php echo $product_id; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <?php if (isset($product['image'])): ?>
                <p>Hình ảnh hiện tại: <img src="/shoesWebsite/assets/images/<?php echo htmlspecialchars($product['image']); ?>" alt="Current Image" width="50"></p>
            <?php endif; ?>
        </div>
        <div class="form-group">
