            ...
            <?php foreach ($members as $member): ?>
                <tr style="border-bottom: 1px solid #ddd;">
                    ...
                    <td style="padding: 10px; border: 1px solid #ddd;">
                        <a href="/shoesWebsite/index.php?controller=adminCustomer&action=customerDetail&id=<?php echo $member['MemberID']; ?>" 
                        ...
                        <a href="/shoesWebsite/index.php?controller=adminCustomer&action=resetPassword&id=<?php echo $member['MemberID']; ?>" 
