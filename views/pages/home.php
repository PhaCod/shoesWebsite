            ...
            <?php foreach ($featuredProducts as $product): ?>
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <a href="/shoesWebsite/index.php?controller=products&action=detail&id=<?php echo $product['ProductID']; ?>" class="btn">View Details</a>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
            ...
            <p style="text-align: center; color: #777;">No categories available.</p>
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <a href="/shoesWebsite/index.php?controller=products&action=index&category=<//?php echo urlencode($category['CategoryID']); ?>" class="btn">Shop Now</a>
                    </div>
                </div>
            <//?php endforeach; ?>
        <//?php endif; ?>
